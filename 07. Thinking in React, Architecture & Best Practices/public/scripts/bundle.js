...
},{"../alt":38,"../utilities/RequesterTMDB":71}],35:[function(require,module,exports){
'use strict';
...
},{"../actions/UserActions":37,"../components/Footer":40,"../components/Navbar":43,"../stores/UserStore":69,"react":"react"}],40:[function(require,module,exports){
'use strict';
...
},{"../actions/MovieActions":34,"../stores/MovieStore":67,"react":"react","react-router":"react-router"}],41:[function(require,module,exports){
'use strict';
...
},{"../actions/MovieActions":34,"../stores/MovieStore":67,"./sub-components/MovieCard":53,"react":"react"}],42:[function(require,module,exports){
'use strict';
...
},{"../../server/utilities/Helpers":72,"../actions/MovieAddActions":35,"../stores/MovieAddStore":66,"react":"react"}],43:[function(require,module,exports){
'use strict';
...
},{"../actions/NavbarActions":36,"../stores/NavbarStore":68,"./sub-components/NavbarUserMenu":57,"react":"react","react-router":"react-router"}],44:[function(require,module,exports){
'use strict';
...
},{"../actions/FormActions":33,"../actions/UserActions":37,"../stores/FormStore":65,"./form/Form":47,"./form/Submit":50,"./form/TextGroup":51,"react":"react"}],45:[function(require,module,exports){
'use strict';
  ...
  _createClass(UserProfile, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_UserInfo2.default, { roles: this.state.roles, information: this.state.information }),
        _react2.default.createElement(_UserRatedMovies2.default, null)
      );
    }
  }]);
...
},{"../stores/UserStore":69,"./sub-components/UserInfo":58,"./sub-components/UserRatedMovies":59,"./sub-components/UserReviews":61,"react":"react"}],46:[function(require,module,exports){
'use strict';
...
},{"../actions/FormActions":33,"../actions/UserActions":37,"../stores/FormStore":65,"./form/Form":47,"./form/RadioElement":48,"./form/RadioGroup":49,"./form/Submit":50,"./form/TextGroup":51,"react":"react"}],47:[function(require,module,exports){
'use strict';
...
},{"../../actions/FormActions":33,"../../actions/MovieActions":34,"../../stores/FormStore":65,"react":"react"}],53:[function(require,module,exports){
'use strict';
...
},{"../../../server/utilities/Helpers":72,"./MovieInfo":55,"react":"react","react-router":"react-router"}],54:[function(require,module,exports){
'use strict';
...
},{"../../../server/utilities/Helpers":72,"react":"react","react-router":"react-router"}],56:[function(require,module,exports){
'use strict';
...
},{"../../actions/FormActions":33,"../../actions/MovieActions":34,"../../stores/FormStore":65,"react":"react"}],57:[function(require,module,exports){
'use strict';
    ...
    value: function render() {
      ...
      if (!this.state.loggedInUserId) {
        userMenu = _react2.default.createElement(
          'ul',
          { className: 'nav navbar-nav pull-rigth' },
          _react2.default.createElement(
            'li',
            null,
            _react2.default.createElement(
...
},{"../../actions/UserActions":37,"../../stores/UserStore":69,"react":"react","react-router":"react-router"}],58:[function(require,module,exports){
'use strict';
...
},{"./UserRatedMoviesPanel":60,"react":"react"}],60:[function(require,module,exports){
'use strict';
...
var UserRatedMoviesPanel = function (_React$Component) {
  _inherits(UserRatedMoviesPanel, _React$Component);

  function UserRatedMoviesPanel(props) {
    _classCallCheck(this, UserRatedMoviesPanel);

    return _possibleConstructorReturn(this, (UserRatedMoviesPanel.__proto__ || Object.getPrototypeOf(UserRatedMoviesPanel)).call(this, props));
  }

  _createClass(UserRatedMoviesPanel, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
...
},{"./UserReviewsPanel":62,"react":"react"}],62:[function(require,module,exports){
'use strict';
...
},{"./routes":64,"history/lib/createBrowserHistory":20,"react":"react","react-dom":"react-dom","react-router":"react-router"}],64:[function(require,module,exports){
'use strict';
...
exports.default = _react2.default.createElement(
  ...
  _react2.default.createElement(_reactRouter.Route, { exact: true, path: '/user/register', component: _UserRegister2.default }),
  _react2.default.createElement(_reactRouter.Route, { exact: true, path: '/user/login', component: _UserLogin2.default })
);

},{"./components/App":39,"./components/Home":41,"./components/MovieAdd":42,"./components/UserLogin":44,"./components/UserProfile":45,"./components/UserRegister":46,"./utilities/Authorize":70,"react":"react","react-router":"react-router"}],65:[function(require,module,exports){
'use strict';
...
},{"../actions/FormActions":33,"../actions/MovieActions":34,"../actions/UserActions":37,"../alt":38}],66:[function(require,module,exports){
'use strict';
  ...
  _createClass(MovieAddStore, [{
    ...
    value: function onHandleGenresChange(e) {
      ...
      if (this.genres.indexOf(genreValue) === -1) {
        ...
        this.genres = _Helpers2.default.removeFromArray(genreValue, this.genre);
      }
      this.genresValidationState = '';
      this.helpBlock = '';
    }
...
},{"../../server/utilities/Helpers":72,"../actions/MovieAddActions":35,"../alt":38}],67:[function(require,module,exports){
'use strict';
...
var MovieStore = function () {
  ...
  _createClass(MovieStore, [{
    ...
    key: 'onEmptyTopTenMoies',
    value: function onEmptyTopTenMoies() {
      this.topTenMovies = [];
    }
  }, {
    key: 'onGetTopTebMoviesFail',
    value: function onGetTopTebMoviesFail(err) {
    ...
    value: function onGetFiveRecentMoviesFail(err) {
      console.log('Couldn\'t connect to DB!', err);
    }
  }]);
...
},{"../actions/MovieActions":34,"../alt":38}],68:[function(require,module,exports){
'use strict';
...
},{"../actions/NavbarActions":36,"../alt":38}],69:[function(require,module,exports){
'use strict';
...
},{"../actions/UserActions":37,"../alt":38}],70:[function(require,module,exports){
'use strict';
...
var Concealer = exports.Concealer = function (_React$Component) {
  _inherits(Concealer, _React$Component);
  ...
  function Concealer(props) {
    ...
    _this2.state.UserStore.getState();
...
},{"../actions/FormActions":33,"../stores/UserStore":69,"react":"react"}],71:[function(require,module,exports){
'use strict';
...
var MISSING_DATA_POSTER_URL = '/images/movie-missin-data.jpg';
...
var _MovieVotePanel = require('../../client/components/sub-components/MovieVotePanel');

var _MovieVotePanel2 = _interopRequireDefault(_MovieVotePanel);

var _MovieCommentsPanel = require('../../client/components/sub-components/MovieCommentsPanel');
  ...
  _createClass(Helpers, null, [{
    ...
    value: function nodesMovieCard(state, props, toggleCommentsPanel, toggleVotePanel) {
      ...
      if (state.showCommentsPanel) {
        nodes.commentsPanel = _react2.default.createElement(_MovieCommentsPanel2.default, { comments: props.movie.comments, movieId: props.movie._id });
      }
...
},{"../../client/components/sub-components/MovieCommentsPanel":54,"../../client/components/sub-components/MovieVotePanel":56,"react":"react","react-router":"react-router"}]},{},[63])
